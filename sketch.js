...
function pinkCyclists(){
        pinkC =createSprite(1100,Math.round(random(50, 250)));
        pinkC.scale =0.06;
...
function obstacle1(){
        obs1 =createSprite(1100,Math.round(random(50, 250)));
        obs1.scale =0.1;
        obs1.debug=false;
...
function obstacle2(){
        obs2 =createSprite(1100,Math.round(random(50, 250)));
        obs2.scale =0.1;
        obs2.debug=false;
...
function obstacle3(){
        obs3 =createSprite(1100,Math.round(random(50, 250)));
        obs3.scale =0.1;
        obs3.debug=false;
